...
var seq__7030_7034 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__7031_7035 = null;
var count__7032_7036 = (0);
var i__7033_7037 = (0);
while(true){
if((i__7033_7037 < count__7032_7036)){
var str_7038 = cljs.core._nth.call(null,chunk__7031_7035,i__7033_7037);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_7038})));
...
var temp__5753__auto___7043 = cljs.core.seq.call(null,seq__7030_7034);
if(temp__5753__auto___7043){
var seq__7030_7044__$1 = temp__5753__auto___7043;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__7030_7044__$1)){
var c__4556__auto___7045 = cljs.core.chunk_first.call(null,seq__7030_7044__$1);
var G__7046 = cljs.core.chunk_rest.call(null,seq__7030_7044__$1);
var G__7047 = c__4556__auto___7045;
var G__7048 = cljs.core.count.call(null,c__4556__auto___7045);
var G__7049 = (0);
...
var str_7050 = cljs.core.first.call(null,seq__7030_7044__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_7050})));
...
var script__$1 = (function (){var G__7059 = script;
goog.object.set(G__7059,"type","text/javascript");

goog.object.set(G__7059,"onload",onload);

goog.object.set(G__7059,"onreadystatechange",onload);

return G__7059;
})();
if((opt_sourceText == null)){
var G__7060 = script__$1;
goog.object.set(G__7060,"src",src);

return G__7060;
} else {
var G__7061 = script__$1;
goog.dom.setTextContent(G__7061,opt_sourceText);
...
var path_7062 = goog.debugLoader_.getPathFromDeps_(src);
goog.object.remove(goog.debugLoader_.written_,path_7062);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_7062)].join(''));
} else {
var path_7063 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_7063);

goog.object.remove(goog.dependencies_.written,path_7063);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_7063)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__7064 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__7065 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__7065);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__7064);
}})()})));
}));
