...
var digit_3676 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_3677__$1 = (vlq >>> (5));
while(true){
if((vlq_3677__$1 > (0))){
var digit_3678__$1 = (digit_3676 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_3678__$1));

var G__3679 = (vlq_3677__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__3680 = (vlq_3677__$1 >>> (5));
digit_3676 = G__3679;
vlq_3677__$1 = G__3680;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_3676));
}
break;
}
...
var G__3681 = i__$1;
var G__3682 = result__$1;
var G__3683 = shift__$1;
i = G__3681;
result = G__3682;
shift = G__3683;
continue;
