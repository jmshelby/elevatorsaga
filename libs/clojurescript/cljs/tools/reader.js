...
var G__766 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__766;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__767 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__767,ch);
...
if(("\\" === ch__$1)){
var ch_768__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_768__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_768__$2);
} else {
}

var G__769 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__769;
continue;
}
}
...
var vec__777 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__777,(0),null);
var start_column = cljs.core.nth.call(null,vec__777,(1),null);
...
var G__780 = cljs.core.conj_BANG_.call(null,a,form);
a = G__780;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__781 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__782 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__782);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__781);
}});
/**
...
var vec__789 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__789,(0),null);
var start_column = cljs.core.nth.call(null,vec__789,(1),null);
...
var vec__792 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__792,(0),null);
var end_column = cljs.core.nth.call(null,vec__792,(1),null);
...
var vec__795 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__795,(0),null);
var start_column = cljs.core.nth.call(null,vec__795,(1),null);
...
var vec__798 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__798,(0),null);
var end_column = cljs.core.nth.call(null,vec__798,(1),null);
...
var sb = (function (){var G__801 = (new goog.string.StringBuffer());
G__801.append(initch);
...
var G__803 = (function (){var G__802 = sb;
G__802.append(ch);

return G__802;
})();
var G__804 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__803;
ch = G__804;
continue;
}
...
switch (G__807) {
case "\\":
var G__811 = (function (){var G__808 = sb;
G__808.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__808;
})();
var G__812 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__811;
ch = G__812;
continue;
...
break;
default:
var G__813 = (function (){var G__809 = sb;
G__809.append(ch);

return G__809;
})();
var G__814 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__813;
ch = G__814;
continue;
...
var vec__815 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__815,(0),null);
var end_column = cljs.core.nth.call(null,vec__815,(1),null);
...
var vec__818 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__818,(0),null);
var column = cljs.core.nth.call(null,vec__818,(1),null);
...
var vec__823 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__823,(0),null);
var column = cljs.core.nth.call(null,vec__823,(1),null);
...
var vec__828 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__828,(0),null);
var column = cljs.core.nth.call(null,vec__828,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__833 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__833,(0),null);
var start_column = cljs.core.nth.call(null,vec__833,(1),null);
...
var vec__836 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__836,(0),null);
var end_column = cljs.core.nth.call(null,vec__836,(1),null);
...
var G__839 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__839,true,null,opts,pending_forms);
...
var G__840 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__840)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__840)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__840)){
...
var _STAR_suppress_read_STAR__orig_val__841 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__842 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__842);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__841);
}});
...
var G__843 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__843,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__843,rdr,first_line);
...
var G__847 = matched;
var G__848 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__847;
finished = G__848;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__849 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__850 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__850);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__849);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__851 = cljs.tools.reader.arg_env;
var arg_env_temp_val__852 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__852);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__853 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__853,"(");
...
var G__854 = (i + (1));
var G__855 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__851);
}});
/**
...
var ch = temp__5751__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__856 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__856);
...
var G__857 = cljs.core.next.call(null,s__$1);
var G__858 = ret;
s__$1 = G__857;
r = G__858;
continue;
...
var G__859 = cljs.core.next.call(null,s);
var G__860 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__859;
key_vals = G__860;
continue;
} else {
...
var gensym_env_orig_val__865 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__866 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__866);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__865);
}});
...
var temp__5751__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__867 = token;
var G__867__$1 = (((G__867 == null))?null:cljs.core.subs.call(null,G__867,(1)));
var G__867__$2 = (((G__867__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__867__$1));
var G__867__$3 = (((G__867__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__867__$2));
var G__867__$4 = (((G__867__$3 == null))?null:cljs.core.symbol.call(null,G__867__$3));
if((G__867__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__867__$4);
}
})():(function (){var G__868 = token;
var G__868__$1 = (((G__868 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__868));
if((G__868__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__868__$1);
}
})()
));
if(cljs.core.truth_(temp__5751__auto__)){
...
}catch (e875){if((e875 instanceof Error)){
var e = e875;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__879,reader){
var map__880 = p__879;
...
var opts = map__880__$1;
var eof = cljs.core.get.call(null,map__880__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
